  ...
  return (
    <>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-3">
        <div className="md:col-span-2 rounded-2xl mb-8">
          ...
          <p className="text-lg text-secondary-text leading-relaxed mb-6">
            I am a Software Engineer with a strong background in web
            development, full-stack engineering, distributed systems, and
            micro-services. My experience in software development encompasses
            various aspects of engineering, and I thrive on solving complex
            problems and building robust solutions.
          </p>

          <p className="text-lg text-secondary-text leading-relaxed mb-6">
            Beyond my professional expertise, I have a deep passion for music
            and music production. Combining my technical skills with my love for
          ...
          <p className="text-lg text-secondary-text leading-relaxed mb-6">
            ...
            leverage my technical skills and passion for music to create
